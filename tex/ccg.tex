...
It is based on the Vijay-Shanker CCG formalism \cite{vs}.
...
\begin{greenbox}
    I call this algorithm CYK' and not something else because it very much
    resembles the CYK algorithm for context-free grammars. It's not called
    CYK because CYK is already taken.
\end{greenbox}
