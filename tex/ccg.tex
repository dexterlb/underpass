...
For iterative derivation, we will use strings in $(\lb \cclos{\tau} \rb \cup \Sigma)^*$,\discuss{\scriptsize Няма ли да е удобно да въведеш нотация за множеството $(\lb \cclos{\tau} \rb \cup \Sigma)^*$? Например $S(\tau)$ или нещо такова.}
