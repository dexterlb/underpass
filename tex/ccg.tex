...
\begin{defn}\label{def:ccg:rules}
    ...
    $\alpha \gderiv_G \beta$.\fixednote{\scriptsize трета семантика на $\gderiv$}
...
\begin{defn}
    Derivation process\fixednote{\scriptsize $\gstep_G$ вече се използва за абстракциите.}
    \begin{itemize}
...
CCG $G$, as well
as the functions $ crown: \trees{G} \fun ( \lb \cclos{N} \rb \cup \Sigma )^* $,
$ root: \trees{G} \fun \cclos{N} \cup \Sigma$.
