...
$U(X, Y)$ which tells us whether the two atomic categories unify. It can then be
...
as $\less$ and then extending it over $\cclos{N}$ as describen in \cref{hack:unification},
