...
For clarity, slash indices will be denoted with latin letters ($\mc_i$
...
($\lc_\mu$ and  $\rc_\mu$ denote the respective
...
\begin{defn}
    ...
    \begin{enumerate}
        ...
        \item \label{cmod:right}  $X, Y \in C(\tau), \mu \in \mathcal{M} \Rightarrow \lp X \rc_\mu Y \rp \in C(\tau)$
        \item \label{cmod:left}   $X, Y \in C(\tau), \mu \in \mathcal{M} \Rightarrow \lp X \lc_\mu Y \rp \in C(\tau)$
    \end{enumerate}
\end{defn}
...
\begin{itemize}
    \item "Application"
        \[ \lb X \rb \rightarrow \lb X \rc_\mu Y \rb \lb Y \rb \]
        \[ \lb X \rb \rightarrow \lb Y \rb \lb X \lc_\mu Y \rb \]
        where $\mu \less \modstar$ (effectively for any $\mu$).
    \item "Harmonic composition"
        \[ \lb X \rc_\eta Z_1 \mc_2 Z_2 ... \mc_\mu Z_m \rb \rightarrow \lb X \rc_\mu Y \rb \lb Y \rc_\nu Z_1 \mc_2 Z_2 ... \mc_m Z_m \rb \]
        \[ \lb X \lc_\eta Z_1 \mc_2 Z_2 ... \mc_\mu Z_m \rb \rightarrow \lb Y \lc_\mu Z_1 \mc_2 Z_2 ... \mc_m Z_m \rb \lb X \lc_\nu Y \rb \]
        where $\mu \less \modr, \nu \less \modr, \eta = \mu \meet \nu$.
    \item "Crossing composition"
        \[ \lb X \lc_\eta Z_1 \mc_2 Z_2 ... \mc_m Z_m \rb \rightarrow \lb X \rc_\mu Y \rb \lb Y \lc_\nu Z_1 \mc_2 Z_2 ... \mc_m Z_m \rb \]
        \[ \lb X \rc_\eta Z_1 \mc_2 Z_2 ... \mc_m Z_m \rb \rightarrow \lb Y \rc_\mu Z_1 \mc_2 Z_2 ... \mc_m Z_m \rb \lb X \lc_\nu Y \rb \]
