...
always terminates.\marginpar{\scriptsize ако говориш за propagate, е хубаво да се докаже по-формално}
...
}\marginpar{\scriptsize това е второто такова разсъждение. Може би имаш нужда от някаква лема от вида: ако унификаторът е еди какъв си, то неподвижната точка на propagate изисква краен брой стъпки}, which is now ready for the translation phase.
...
\begin{itemize}
    ...
    \item Recursively evaluate (translate) all arguments
        ...
        is always a constant and the arguments are of non-arrow types\marginpar{\scriptsize защо аргументите не може да са стрелки?})
