...
always terminates.\note{ако говориш за propagate, е хубаво да се докаже по-формално}
...
}\note{това е второто такова разсъждение. Може би имаш нужда от някаква лема от вида: ако унификаторът е еди какъв си, то неподвижната точка на propagate изисква краен брой стъпки}, which is now ready for the translation phase.
