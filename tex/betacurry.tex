...
to a sequence of arguments:\marginpar{\scriptsize съгласно тази дефиниция аргументите може да са от тип със стрелки, противно на това, което е казано в \cref{sec:translation}}
\begin{itemize}
