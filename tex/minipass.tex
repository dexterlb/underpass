...
\begin{center}
    \begin{tabular}{ p{0.45\textwidth} p{0.45\textwidth} }
        Label & Semantics \\
        \hline
        \pbox{0.4\textwidth}{\vspace{1em} \code{['tagFilter',} \\ \code{  ['=', <key>, <value>]]}} & Items which contain a
            tag that has the given key and value \cendrow
        \pbox{0.4\textwidth}{\vspace{1em} \code{['tagFilter',} \\ \code{  ['~', <key>, <regex>]]}} & Items which contain a
