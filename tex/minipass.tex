...
and has not been
already user-defined.\fixednote{\scriptsize необходимо ли е да казваме, че ``\code{NewType} is not a supertype of \code{OldType} - A: да: може да е вграден'' след като казваме, че ``has not been already defined?''}
