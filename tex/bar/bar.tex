...
\begin{proof}
    ...
    Let $ \lb X \rb \Rightarrow \alpha_1 \Rightarrow ... \Rightarrow \alpha_r = w_i ... w_j, i \leq j $
    be a derivation. We now perform induction over the derivation steps from
    right to left:
    \begin{itemize}
        \item $\alpha_r$: actually, that doesn't help at all :(
    \end{itemize}
    Then \[
