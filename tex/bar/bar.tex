...
\begin{defn}
    We say $\lb X \rb \Rrightarrow \alpha T \beta$ is a
    \emph{primary derivation} from $\lb X \rb$ to $T$ if:
    \begin{itemize}
        \item $T \in \Sigma$ or $T \in C(N)$
        \item $\lb X \rb \Rrightarrow \alpha \lb T \rb \beta$
        \item The path in the tree from the root $ X $ to the leaf $ T $
