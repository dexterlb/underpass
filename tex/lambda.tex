...
\begin{proof}
    ...
    Suppose that $S'$ has no minimum, i.e. there exists an infinite descending
    chain of nonequal elements
    \[ ... \termless{T}{C}
       \ttt{M_3}{\tau_0} \termless{T}{C} \ttt{M_2}{\tau_0} \termless{T}{C}
       \ttt{M_1}{\tau_0} \termless{T}{C} \ttt{M_0}{\tau_0} \]
    ...
    \begin{itemize}
        \item For every $i \in \mathbb{N}$, $M_i = P_i Q_i$:

            We know that $\termlen{P_i} \le \termlen{M_i}$ and
            $\termlen{Q_i} \le \termlen{M_i}$.
...
\begin{proof}
    ...
    To prove well-foundedness, take a set $S \subseteq \ttlambda{T}{C}$ and fix
