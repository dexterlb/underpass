...
\begin{proof}
    ...
    \begin{itemize}
        \item For every $i \in \mathbb{N}$, $M_i$ is a Constant or Variable:

            In this case, an infinite chain is trivially impossible since
            constants and variables are only in relation with themselves.
