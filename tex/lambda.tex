...
\begin{defn}
    ...
    \begin{itemize}
        ...
        \item Construction via downcast (dangerous, doesn't need to be included in most cases\fixednote{\scriptsize не видях в текста никъде да използваш downcast, ако наистина е така, може би е по-добре да го махнеш}            \cenderiv{
                \hypo{\Gamma \vdash A : \sigma}
                \hypo{\tau \less \sigma}
                \infer2{\Gamma \vdash \tau[A] : \tau}
            }
...
\begin{defn}
    ...
    \begin{itemize}
        ...
        \item a mapping $\varphi : T \fun \tclos{T}$\fixednote{\scriptsize тук означението $\pfun$ се появява за пръв път без да е обяснено, не мисля че може да се счита стандартно означение на частична функция.}
