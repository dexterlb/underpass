...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item $\sigma \lass \tau \in \Theta \implies \varphi(\sigma) \less' \hat{\varphi}(\tau)$
            ...
            Since at each step we only add elements to the domain of
            $\varphi$ and don't change its effect on previous elements,
            we can directly say that this is true given \cref{lemma:subadd:phi}
            \fixme{no!}
    \end{itemize}
    \fixme{need proof revision}
\end{proof}
