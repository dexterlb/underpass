...
call $\tau$ \emph{special}. Dually, if $\tau$ is such that
...
\begin{defn}
    ...
    \begin{itemize}
        ...
        \item a type $\tau$ such that $\hat{\varphi}(\tau)$ is defined\marginpar{ако започваш от $\varphi = \emptyset$ това условие няма как да е изпълнено}
    \end{itemize}
